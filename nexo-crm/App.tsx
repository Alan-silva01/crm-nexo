...
const App: React.FC = () => {
  ...
  const renderContent = () => {
    switch (activeTab) {
      ...
      case 'kanban': return <Kanban searchQuery={searchQuery} filteredLeads={filteredLeads} onLeadsUpdate={setLeads} />;
      case 'leads': return <LeadsList searchQuery={searchQuery} filteredLeads={filteredLeads} />;
      case 'chats': return <WhatsAppChat leads={leads} onLeadsUpdate={setLeads} />;
      case 'analytics': return <DetailedAnalytics />;
          ...
          <div className="flex items-center gap-4">
             ...
             <div className="flex items-center gap-3 ml-2 pl-4 border-l border-zinc-800/50">
               <div className="text-right hidden sm:block">
                 <p className="text-[11px] font-semibold leading-none">João Silva</p>
                 <button 
